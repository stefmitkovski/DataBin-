...
namespace DataBin.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var dataBinContext = _context.Comment.Include(c => c.Post);
            return View(await dataBinContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,CreatedAt,LastUpdatedAt,PostId")] Comment comment)
        {
